        ...
        <Accordion elevation={3} sx={{ width: "40%" }}>
          ...
          <AccordionDetails>
            <Typography color="textPrimary">
              ...
              <br /> Only one of each class may be in the same guild. Surviving
              in a guild is easier if you have a balanced and larger team, so
              try to join a guild with more members.
              <br />
              <br /> If you are the first to join a guild, you will be the
              initial guild leader. Guild leaders rotate, between all members of
              the guild.
              <br />
              <br />
