...
const health: Ability[] = [
  ...
  // Base efficiency = 25 XP / 2 Mana = 12.5
  // Target multiplier = 1.2x = 15.0
  // Dice bonus = +1.0 efficiency = 16.0
  // Final Efficiency: 16.0
  {
    id: 1,
    name: "Vigor",
    category: "Health",
...
const wizard: Ability[] = [
  ...
  // Base: 25 XP / 2 Mana = 12.5
  // No duration penalty
  // Final: 12.5 efficiency
  {
    id: 17,
    name: "Inner-Power",
    category: "Wizard",
  ...
  //   target: "All",
  //   description:
  //     "You show your guildmates the secrets of the arcane. All members of the guild gain an additional 2 mana every time they gain mana.",
  //   duration: null,
...
const barbarian: Ability[] = [
  ...
  // Base: 200 XP / 6 Mana = 33.33
  // Duration penalty: -25% = 25.0
  // Final: 25.0 efficiency
  {
    id: 36,
...
const bard: Ability[] = [
  ...
  // Base: 25 XP / 2 Mana = 12.5
  // Duration penalty: -10% = 11.25
  // Final: 11.25 efficiency
  {
    id: 46,
