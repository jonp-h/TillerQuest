...
const health = [
  ...
  },
  {
    ...
    type: "Heal",
    target: -1,
    description: "Restores 2 health to yourself.",
    duration: null,
    icon: "Heal.png",
    gemstoneCost: 2,
    manaCost: 2,
...
const wizard = [
  ...
  },
  {
    ...
    type: "Transfer",
    target: 1,
    description: "You channel your powers, giving a guildmember 10 mana.",
    duration: null,
    // icon: "Greater-Essence-Transfer.png",
    gemstoneCost: 6,
    manaCost: 10,
...
const druid = [
  ...
  },
  {
    ...
    type: "Heal",
    target: 0,
    description: "Restores 5 health to all guildmembers.",
    duration: null,
  ...
  },
  {
    ...
    type: "Heal",
    target: 1,
    description: "Restores a target to full health.",
    duration: null,
    // icon: "Rejuvinate.png",
    gemstoneCost: 6,
    manaCost: 12,
...
const barbarian = [
  ...
  },
  {
    ...
    target: 1,
    description:
      "You shield a guildmember from 5 damage for the next 20 minutes.",
    duration: 20,
...
const bloodMage = [
  ...
  },
  {
    ...
    target: -1,
    description:
      "You may sacrifice 5 health and 5 mana to the Gods for 100 XP. Cooldown for 2 days",
  ...
  },
  {
    ...
    target: -1,
    description:
      "You may sacrifice 10 health and 10 mana to the Gods for 175 XP. Cooldown for 5 days",
    ...
    xpGiven: 100,
    value: null,
    parentAbility: "Sacrificial-Lamb",
  },
];
