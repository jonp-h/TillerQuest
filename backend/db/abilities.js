...
const druid = [
  ...
  },
  {
    ...
    type: "Heal",
    target: 1,
    description: "Restores 1d8 health to a target.",
    duration: null,
  ...
  },
  {
    ...
    type: "Heal",
    target: 1,
    description: "Restores 2d8 health to a target.",
    duration: null,
  ...
  },
  {
    ...
    type: "Heal",
    target: 0,
    description: "Restores 2d8 health to all guildmembers.",
    duration: null,
    icon: "Test.jpg",
    gemstoneCost: 4,
    manaCost: 10,
...
const bloodMage = [
  ...
  },
  {
    ...
    type: "Trade",
    target: 1,
    description: "You may trade 5 health, and offer 2 mana to a guildmember.",
    duration: null,
    icon: "Bloodgift.png",
    gemstoneCost: 2,
    manaCost: null,
  ...
  },
  {
    ...
    type: "Trade",
    target: 1,
    description: "You may trade 10 health, and offer 5 mana to a guildmember.",
    duration: null,
  ...
  },
  {
    ...
    target: -1,
    description:
      "NOT YET IMPLEMENTED: You curse the gold earned from the arena, increasing it by 1d10%.",
    duration: null,
    icon: "Test.jpg",
    gemstoneCost: 9999,
    manaCost: 9999,
  ...
  },
  {
    ...
    target: -1,
    description:
      "NOT YET IMPLEMENTED: You curse the gold earned from the arena for all guild members, increasing it by 5d10%.",
    duration: null,
    icon: "Test.jpg",
    gemstoneCost: 9999,
    manaCost: 9999,
